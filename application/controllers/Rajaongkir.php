...
{
    private $api_key = 'dddc44bba6b722b0e336f78911b521b9';
    ...
    {   
        $id_kota_asal   = $this->model_toko->tampil_asal()->kota_id;
        ...
        if ($err) {
            ...
            foreach ($data_paket as $key => $value){
                ...
                echo $value['service']." | Rp. ".number_format($value['cost'][0]['value'], 0,',','.')." | Estimasi ".$value['cost'][0]['etd']." Hari";
                echo "</option>";
