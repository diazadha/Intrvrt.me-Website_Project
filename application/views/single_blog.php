...
<main class="position-relative">
    <div class="container">
        <div class="entry-header entry-header-1 mb-30 mt-50">
            <div class="entry-meta meta-0 font-small mb-30"><a href="category.html"><span class="post-cat bg-success color-white"><?= $this->BlogModel->get_kategori_IN($post->kategori, 'html') ?></span></a></div>
            <h1 class="post-title mb-30">
                <?=$post->judul?>
            </h1>
            <div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
                <span class="post-by">By <a href="author.html"><?=$this->BlogModel->penulis($post->penulis)?></a></span>
