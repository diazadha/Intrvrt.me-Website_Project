         ...
         <div class="container">
             <div class="row">
                 <div class="col-lg-8 col-md-8 mb-3">
                    ...
                    <?php $no = 1; $grand_total = 0; foreach ($keranjang_event as $e) : ?>
                            ...
                            <div class="d-flex flex-row align-items-center">
                                <div class="d-block">
                                    <center>
                                            ...
                                            <input class="text-center" type="text" readonly id="qty_<?= $e['id_keranjang']; ?>" value="<?= $e['qty']; ?>" min="1" style="width: 20%;  border: 1px solid #FF656A; border-radius: 5px">
                    ...
                    <?php $grand_total = $grand_total + $total_harga; endforeach;?>
